...
hist(nflDataUpsetWins$AvgPF,
     breaks = 20,
     ylim = c(0,nrow(nflDataUpsetWins)/5),
     xlim = c(0,50),
     col = "lightblue",
     ylab = "Count",
     xlab = "AvgPF",
...
hist(nflDataUpsetLoses$AvgPF,
     breaks = 20,
     ylim = c(0,nrow(nflDataUpsetLoses)/5),
     xlim = c(0,50),
     col = "lightblue",
     ylab = "Count",
     xlab = "AvgPF",
...
hist(nflDataUpsetWins$Defense,
     breaks = 20,
     ylim = c(0,nrow(nflDataUpsetWins)/12),
     xlim = c(0,12),
     col = "lightblue",
     ylab = "Count",
     xlab = "Defense",
...
hist(nflDataUpsetLoses$Defense,
     breaks = 20,
     ylim = c(0,nrow(nflDataUpsetLoses)/12),
     xlim = c(0,12),
     col = "lightblue",
     ylab = "Count",
     xlab = "Defense",
...
hist(nflDataUpsetLoses$Offense,
     breaks = 20,
     ylim = c(0,nrow(nflDataUpsetLoses)/10),
     xlim = c(0,10),
     col = "lightblue",
     ylab = "Count",
     xlab = "Offense",
...
hist(nflDataUpsetWins$Time,
     breaks = 30,
     ylim = c(0,nrow(nflDataUpsetWins)/2.25),
     xlim = c(800,2200),
     col = "lightblue",
     ylab = "Count",
     xlab = "Game Time",
...
hist(nflDataUpsetLoses$Time,
     breaks = 30,
     ylim = c(0,nrow(nflDataUpsetLoses)/2.25),
     xlim = c(0800,2200),
     col = "lightblue",
     ylab = "Count",
     xlab = "Game Time",
...
hist(nflDataUpsetWins$AorH,
     ...
     ylab = "Count",
     xlab = "Away or Home",
     main = "Histogram of Upset Wins Away or Home")
hist(nflDataUpsetLoses$AorH,
     breaks = 30,
     ylim = c(0,nrow(nflDataUpsetLoses)/1.5),
     xlim = c(0,1),
     col = "lightblue",
...
classifier <- naiveBayes(UpsetAmt ~ AorH + Time + Weather + AvgPF + AvgPA + Odds, data = nflDataUpsetWinsFiltered, method = "class")
